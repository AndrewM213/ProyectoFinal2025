...
public class IniciarSesion extends javax.swing.JFrame {
    ...
    private void initLoadingDialog() {
        loadingDialog = new javax.swing.JDialog(this, "Cargando...", true);
        progressBar = new javax.swing.JProgressBar();
        progressBar.setIndeterminate(true); 
        progressBar.setStringPainted(true);
        progressBar.setString("Inicializando sesion...");

        javax.swing.JLabel loadingLabel = new javax.swing.JLabel("Por favor espere...");
        loadingLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);


        javax.swing.JPanel panel = new javax.swing.JPanel(new java.awt.BorderLayout(10, 10));
        panel.setBorder(javax.swing.BorderFactory.createEmptyBorder(20, 20, 20, 20));
        panel.add(loadingLabel, java.awt.BorderLayout.NORTH);
        panel.add(progressBar, java.awt.BorderLayout.CENTER);

        loadingDialog.setContentPane(panel);
        loadingDialog.pack();
        loadingDialog.setLocationRelativeTo(this);
        loadingDialog.setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE); // Evitar cierre accidental
    }
    ...
    private void initComponents() {
        ...
        btnVerContra.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ojito.png"))); // NOI18N
        btnVerContra.setBorderPainted(false);
        btnVerContra.setContentAreaFilled(false);
        btnVerContra.setSelectedIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/ojito_tachado.png"))); // NOI18N
        btnVerContra.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnVerContraActionPerformed(evt);
            }
        });
        jPanel1.add(btnVerContra, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 330, -1, -1));
    ...
    private void btnIngresarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIngresarActionPerformed
        ...
        final Usuario validado = validarLogin(usuario, contraseña); // Usar 'final' para usar en SwingWorker
            ...
            protected Void doInBackground() throws Exception {
                ...
                protected void done() {
                    try {
                        ...
                        JOptionPane.showMessageDialog(IniciarSesion.this, "Bienvenido, " + validado.getNombreUsuario(), "Información", JOptionPane.INFORMATION_MESSAGE);
                        IniciarSesion.this.dispose();

                    } catch (Exception e) {
                        loadingDialog.dispose();
                        JOptionPane.showMessageDialog(IniciarSesion.this, "Error durante la inicialización: " + e.getMessage(), "Error Crítico", JOptionPane.ERROR_MESSAGE);
                    }
                }
            }.execute();       
