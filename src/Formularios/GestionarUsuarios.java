...
public class GestionarUsuarios extends javax.swing.JFrame {
    ...
    public GestionarUsuarios(ArrayList<Usuario> listaUsuario) {        
        ...
        DefaultTableModel tabla = (DefaultTableModel) tablaU3.getModel();
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        int filaSeleccionada = tablaU3.getSelectedRow();
        if(filaSeleccionada >= 0){
            String id = txtID3.getText();
            String nombre = txtUsuario3.getText();
            String contraseña = txtContraseña3.getText();
            String rol = txtRol3.getText();
